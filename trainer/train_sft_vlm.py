...
if __name__ == "__main__":
    ...
    parser.add_argument("--beta2", type=float, default=0.99, help="动量系数β₂")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/sft_vlm_data.jsonl", help="训练数据路径，../dataset/sft_vlm_data.jsonl or ../dataset/sft_vlm_data_multi.jsonl")
    parser.add_argument("--images_path", type=str, default="../dataset/sft_images", help="训练数据路径，../dataset/sft_images or ../dataset/sft_multi_images")
